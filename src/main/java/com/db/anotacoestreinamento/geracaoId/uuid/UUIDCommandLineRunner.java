...
@Component
public class UUIDCommandLineRunner implements CommandLineRunner {

    private UsuarioRepository repository;

    private static final Logger logger = LoggerFactory.getLogger(UUIDCommandLineRunner.class);

    public UUIDCommandLineRunner(UsuarioRepository repository){
